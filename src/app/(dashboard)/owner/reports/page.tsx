    ...
    <div className="space-y-6 p-2 lg:p-0">
      <div>
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
          <div>
            <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Laporan Klinik</h1>
            <p className="text-gray-500 text-sm mt-1">Analisis performa klinik</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-4 border border-gray-100 flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:items-center">
          ...
          <div className="flex-1 relative min-w-0">
            ...
            <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Cari..." className="w-full pl-9 pr-4 py-2 rounded-xl border border-gray-200 text-sm" onKeyDown={e => e.key === "Enter" && handleSearch()} />
          </div>
          <div className="flex gap-2 sm:flex-shrink-0">
            <button onClick={handleSearch} className="flex-1 sm:flex-none px-4 py-2 rounded-xl gradient-primary text-white text-sm font-medium">Cari</button>
